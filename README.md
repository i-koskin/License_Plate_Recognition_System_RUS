...
## Система автоматического распознавания автомобильных номеров с поддержкой кириллицы на базе моделей YOLOv8, PaddleOCR и ByteTrack.
...
- 🚗 Детекция транспортных средств (автомобили, автобусы, грузовики) с трекингом автомобилей между кадрами с помощью ByteTrack из библиотеки Supervision
